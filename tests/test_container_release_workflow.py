...
def test_release_chain_is_default_off_and_dependency_gated() -> None:
    ...
    assert (
        "needs: [release-metadata, publish-images, build-agent-package]" in manifest
    )
...
def test_apt_publication_consumes_the_unified_release_artifact() -> None:
    ...
    assert (
        "needs: [release-metadata, build-agent-package, release-manifest]" in apt
    )
...
def test_final_job_creates_checksum_protected_public_release_asset() -> None:
    ...
    assert (
        "needs: [release-metadata, publish-images, build-agent-package]" in text
    )
