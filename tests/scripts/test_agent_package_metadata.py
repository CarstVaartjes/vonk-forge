...
def test_development_metadata_emits_canonical_debian_outputs() -> None:
    ...
    assert result.stdout.splitlines() == [
        ...
        "amd64_package=vonk-forge-agent_0.1.1~dev.417+g0123456789ab_amd64.deb",
        "arm64_baseline_package=vonk-forge-agent_0.1.0~acceptance.1+g0123456789ab_arm64.deb",
        "amd64_baseline_package=vonk-forge-agent_0.1.0~acceptance.1+g0123456789ab_amd64.deb",
...
def test_production_metadata_emits_canonical_stable_outputs() -> None:
    ...
    assert result.stdout.splitlines() == [
        ...
        "amd64_package=vonk-forge-agent_0.1.1_amd64.deb",
        "arm64_baseline_package=vonk-forge-agent_0.1.0~acceptance.1+g0123456789ab_arm64.deb",
        "amd64_baseline_package=vonk-forge-agent_0.1.0~acceptance.1+g0123456789ab_amd64.deb",
