...
def _copy(tmp_path: Path) -> Path:
    ...
    for path in (
        ...
        "control/src/vonk_control/download_contract.py",
        "control/src/vonk_control/settings.py",
        "control/src/vonk_control/logging.py",
        ...
        "scripts/agent_package_source_publication.py",
