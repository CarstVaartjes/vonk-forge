...
recipe at commit `3c9576c52ab71d89e22fe4621e0d32300a59039a` (2026-08-13).

The files under `patches/` and `LICENSE.mia-upstream` are copied from that
commit. Source bytes are unchanged except that the issue-27 Python file gains
the repository's conventional final newline. `encoding/encoding_dsv4.py` is
copied byte-for-byte from the
official `deepseek-ai/DeepSeek-V4-Flash-0731` model snapshot at revision
`9e165c30e2704aec5d9d593cce3eebd58bbef1cb`.

The upstream suppress-stops-in-reasoning hotfix is enabled by default, matching
the selected recipe.
