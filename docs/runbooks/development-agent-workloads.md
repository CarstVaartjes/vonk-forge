...
every ten seconds that the same labeled container is still running. An exited
container must fail the operation and be cleaned up rather than waiting on
continued lease renewals.
