...
| Spark agent package | Both physical Sparks run signed package `0.1.0~dev.124+g28906648db8a`, active slot A, binary SHA-256 `8dff952221e338427b9ddb267e2e7c514825ea8709a6a2af1cf9ea73d9c8deb1`, and Rust protocol 3. Both supervisors converged `stable`, reported `rollback_performed=false`, and retained active services. The controller observed both nodes active, non-stale, and less than one second old after rollout. | Passed |
