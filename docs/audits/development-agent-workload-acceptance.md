...
| Real two-node gang | Run `model-multinode` with both exact target nodes | Equal image/artifact-set identities, all-rank readiness, sole entrypoint inference | Pending |
