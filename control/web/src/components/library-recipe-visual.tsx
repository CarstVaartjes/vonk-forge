...
export function LibraryRecipeVisual({document, modelDocuments = []}: {document: LibraryViewRecipeDetail["definition"]; modelDocuments?: LibraryViewRecipeDetail["model_documents"]}) {
