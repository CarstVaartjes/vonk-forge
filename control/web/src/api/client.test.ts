...
it("previews and applies one digest-bound fleet-wide model deletion", async () => {
  ...
  const plan = {
    ...
    plan_digest: "model-delete-plan", shared_cache_policy: "Shared/global downloaded model caches remain installed; only selected installation copies are eligible for cleanup.", warnings: [],
  };
