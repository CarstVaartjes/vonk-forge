...
def test_recipe_library_requires_the_catalog_index() -> None:
    commit = "a" * 40
    calls: list[str] = []
    ...
    assert exc_info.value.code == "recipe_library.not_found"
    assert calls == [
...
def test_recipe_library_rejects_schema_one_index() -> None:
