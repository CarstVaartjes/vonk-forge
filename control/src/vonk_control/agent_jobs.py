    ...
    def _claim_has_authority(
        ...
        *,
        ...
        if (
            ...
            return False
        if self._revision_eligible is not None and self._current_revision is not None:
            try:
                if (
                    not self._revision_eligible(job.authority_revision)
                    or self._current_revision() != job.authority_revision
                ):
                    return False
