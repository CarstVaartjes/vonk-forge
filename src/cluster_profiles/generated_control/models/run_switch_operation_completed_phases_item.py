...
RUN_SWITCH_OPERATION_COMPLETED_PHASES_ITEM_VALUES: set[RunSwitchOperationCompletedPhasesItem] = { 'cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify',  }
