...
T = TypeVar("T", bound="RecipeImageAvailabilityListResponse")



@_attrs_define
class RecipeImageAvailabilityListResponse:
    """
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for operations_item_data in (_operations):
            operations_item = RecipeImageAvailabilityResponse.from_dict(operations_item_data)
        ...
        recipe_image_availability_list_response = cls(
            operations=operations,
            total=total,
        ...
        return recipe_image_availability_list_response
