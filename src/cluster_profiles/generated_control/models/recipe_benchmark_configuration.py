...
T = TypeVar("T", bound="RecipeBenchmarkConfiguration")
...
class RecipeBenchmarkConfiguration:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        recipe_benchmark_configuration = cls(
        )
        ...
        recipe_benchmark_configuration.additional_properties = additional_properties
        return recipe_benchmark_configuration
