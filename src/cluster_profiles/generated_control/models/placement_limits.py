...
class PlacementLimits:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if artifact_evidence_per_node_limit != 512 and not isinstance(artifact_evidence_per_node_limit, Unset):
        ...
        if candidate_node_limit != 32 and not isinstance(candidate_node_limit, Unset):
        ...
        if examined_group_limit != 512 and not isinstance(examined_group_limit, Unset):
        ...
        if operational_member_evidence_limit != 16384 and not isinstance(operational_member_evidence_limit, Unset):
        ...
        if operational_row_evidence_limit != 512 and not isinstance(operational_row_evidence_limit, Unset):
        ...
        if recommendation_limit != 16 and not isinstance(recommendation_limit, Unset):
        ...
        if rejected_group_evidence_limit != 16 and not isinstance(rejected_group_evidence_limit, Unset):
        ...
        if rejected_node_evidence_limit != 32 and not isinstance(rejected_node_evidence_limit, Unset):
