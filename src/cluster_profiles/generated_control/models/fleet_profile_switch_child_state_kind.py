...
FleetProfileSwitchChildStateKind = Literal['cleanup', 'run', 'stop']

FLEET_PROFILE_SWITCH_CHILD_STATE_KIND_VALUES: set[FleetProfileSwitchChildStateKind] = { 'cleanup', 'run', 'stop',  }
