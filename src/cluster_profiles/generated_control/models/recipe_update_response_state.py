...
RecipeUpdateResponseState = Literal['cancelled', 'failed', 'partial', 'queued', 'running', 'succeeded']

RECIPE_UPDATE_RESPONSE_STATE_VALUES: set[RecipeUpdateResponseState] = { 'cancelled', 'failed', 'partial', 'queued', 'running', 'succeeded',  }
