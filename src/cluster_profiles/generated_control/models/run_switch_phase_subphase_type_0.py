...
RUN_SWITCH_PHASE_SUBPHASE_TYPE_0_VALUES: set[RunSwitchPhaseSubphaseType0] = { 'container-build', 'model-download', 'runtime-image', 'runtime-install', 'runtime-plan', 'target-copy',  }
