...
class ModelCacheOperationProgress:
    """
        Attributes:
            ...
            measurement (OperationProgress): Canonical durable progress payload shared by Controller and agents.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurement = OperationProgress.from_dict(d.pop("measurement"))
