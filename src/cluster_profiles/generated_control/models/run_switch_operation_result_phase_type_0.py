...
RunSwitchOperationResultPhaseType0 = Literal['cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify']

RUN_SWITCH_OPERATION_RESULT_PHASE_TYPE_0_VALUES: set[RunSwitchOperationResultPhaseType0] = { 'cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify',  }
