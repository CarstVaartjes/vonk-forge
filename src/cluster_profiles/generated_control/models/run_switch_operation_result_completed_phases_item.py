...
RUN_SWITCH_OPERATION_RESULT_COMPLETED_PHASES_ITEM_VALUES: set[RunSwitchOperationResultCompletedPhasesItem] = { 'cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify',  }
