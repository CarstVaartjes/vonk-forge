...
RunSwitchOperationCurrentPhaseType0 = Literal['cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify']

RUN_SWITCH_OPERATION_CURRENT_PHASE_TYPE_0_VALUES: set[RunSwitchOperationCurrentPhaseType0] = { 'cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify',  }
