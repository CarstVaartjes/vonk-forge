...
if TYPE_CHECKING:
  ...
  from ..models.recipe_library_response_filters import RecipeLibraryResponseFilters
...
class RecipeLibraryResponse:
    """
        Attributes:
            ...
            filters (RecipeLibraryResponseFilters):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filters = RecipeLibraryResponseFilters.from_dict(d.pop("filters"))
