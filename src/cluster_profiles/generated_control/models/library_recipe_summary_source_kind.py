...
LibraryRecipeSummarySourceKind = Literal['global', 'local', 'workload_run']

LIBRARY_RECIPE_SUMMARY_SOURCE_KIND_VALUES: set[LibraryRecipeSummarySourceKind] = { 'global', 'local', 'workload_run',  }
