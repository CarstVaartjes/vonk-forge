...
RecipeImageAvailabilityResponseState = Literal['cancelled', 'failed', 'partial', 'queued', 'running', 'succeeded']

RECIPE_IMAGE_AVAILABILITY_RESPONSE_STATE_VALUES: set[RecipeImageAvailabilityResponseState] = { 'cancelled', 'failed', 'partial', 'queued', 'running', 'succeeded',  }
