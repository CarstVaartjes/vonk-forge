...
T = TypeVar("T", bound="ImageDistributionPreviewRequest")



@_attrs_define
class ImageDistributionPreviewRequest:
    """
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_distribution_preview_request = cls(
            mapping_generation=mapping_generation,
            mapping_id=mapping_id,
            recipe_build_id=recipe_build_id,
        )

        return image_distribution_preview_request
