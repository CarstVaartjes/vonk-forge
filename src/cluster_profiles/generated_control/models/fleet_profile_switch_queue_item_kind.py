...
FleetProfileSwitchQueueItemKind = Literal['cleanup', 'run', 'stop']

FLEET_PROFILE_SWITCH_QUEUE_ITEM_KIND_VALUES: set[FleetProfileSwitchQueueItemKind] = { 'cleanup', 'run', 'stop',  }
