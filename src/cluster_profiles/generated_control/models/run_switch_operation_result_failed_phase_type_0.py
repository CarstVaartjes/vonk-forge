...
RunSwitchOperationResultFailedPhaseType0 = Literal['cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify']

RUN_SWITCH_OPERATION_RESULT_FAILED_PHASE_TYPE_0_VALUES: set[RunSwitchOperationResultFailedPhaseType0] = { 'cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify',  }
