...
LibraryCapabilityProvenanceSourceKind = Literal['model', 'model-capability-evidence', 'recipe']

LIBRARY_CAPABILITY_PROVENANCE_SOURCE_KIND_VALUES: set[LibraryCapabilityProvenanceSourceKind] = { 'model', 'model-capability-evidence', 'recipe',  }
