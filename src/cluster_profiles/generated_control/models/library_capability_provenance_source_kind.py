...
LibraryCapabilityProvenanceSourceKind = Literal['model-capability-evidence', 'model-version', 'recipe-revision']

LIBRARY_CAPABILITY_PROVENANCE_SOURCE_KIND_VALUES: set[LibraryCapabilityProvenanceSourceKind] = { 'model-capability-evidence', 'model-version', 'recipe-revision',  }
