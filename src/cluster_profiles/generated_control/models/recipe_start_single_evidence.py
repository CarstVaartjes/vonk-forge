...
T = TypeVar("T", bound="RecipeStartSingleEvidence")



@_attrs_define
class RecipeStartSingleEvidence:
    """
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rank = cast(Literal[0] , d.pop("rank"))
        if rank != 0:
            raise ValueError(f"rank must match const 0, got '{rank}'")
        ...
        world_size = cast(Literal[1] , d.pop("world_size"))
        if world_size != 1:
        ...
        recipe_start_single_evidence = cls(
            artifact_set_digest=artifact_set_digest,
            endpoint=endpoint,
            evidence_digest=evidence_digest,
            image_digest=image_digest,
        ...
        return recipe_start_single_evidence
