...
T = TypeVar("T", bound="VisualTerritorialRestrictions")



@_attrs_define
class VisualTerritorialRestrictions:
    """
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        visual_territorial_restrictions = cls(
            denied_jurisdictions=denied_jurisdictions,
            notice=notice,
        )

        return visual_territorial_restrictions
