...
T = TypeVar("T", bound="FleetNodeDetailResponse")



@_attrs_define
class FleetNodeDetailResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        labels = FleetNodeDetailResponseLabels.from_dict(d.pop("labels"))
        ...
        fleet_node_detail_response = cls(
            connection=connection,
            display_name=display_name,
            hostname=hostname,
            id=id,
        ...
        return fleet_node_detail_response
