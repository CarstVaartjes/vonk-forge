...
T = TypeVar("T", bound="ModelCacheDownloadPreviewResponse")



@_attrs_define
class ModelCacheDownloadPreviewResponse:
    """
        Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        already_cached_bytes = self.already_cached_bytes
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        already_cached_bytes = d.pop("already_cached_bytes")
        ...
        model_cache_download_preview_response = cls(
            already_cached_bytes=already_cached_bytes,
            artifact_count=artifact_count,
            artifact_set_sha256=artifact_set_sha256,
            blockers=blockers,
        ...
        return model_cache_download_preview_response
