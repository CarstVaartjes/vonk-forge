...
T = TypeVar("T", bound="RecipeProfileParameterOverrides")



@_attrs_define
class RecipeProfileParameterOverrides:
    """
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        recipe_profile_parameter_overrides = cls(
        )
        ...
        recipe_profile_parameter_overrides.additional_properties = additional_properties
        return recipe_profile_parameter_overrides
