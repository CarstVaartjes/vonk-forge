...
T = TypeVar("T", bound="ModelLibraryResponseFilters")



@_attrs_define
class ModelLibraryResponseFilters:
    """
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        model_library_response_filters = cls(
        )
        ...
        model_library_response_filters.additional_properties = additional_properties
        return model_library_response_filters
