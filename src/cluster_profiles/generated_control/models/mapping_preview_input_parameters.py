...
T = TypeVar("T", bound="MappingPreviewInputParameters")



@_attrs_define
class MappingPreviewInputParameters:
    """
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        mapping_preview_input_parameters = cls(
        )
        ...
        mapping_preview_input_parameters.additional_properties = additional_properties
        return mapping_preview_input_parameters
