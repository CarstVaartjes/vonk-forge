...
T = TypeVar("T", bound="ModelCacheEvictionEntry")



@_attrs_define
class ModelCacheEvictionEntry:
    """
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        last_accessed_at = d.pop("last_accessed_at")
        ...
        model_cache_eviction_entry = cls(
            artifact_set_sha256=artifact_set_sha256,
            last_accessed_at=last_accessed_at,
            protected=protected,
            protected_reasons=protected_reasons,
        ...
        return model_cache_eviction_entry
