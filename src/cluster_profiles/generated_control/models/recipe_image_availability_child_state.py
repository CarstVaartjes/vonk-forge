...
RecipeImageAvailabilityChildState = Literal['cancelled', 'failed', 'partial', 'queued', 'running', 'succeeded']

RECIPE_IMAGE_AVAILABILITY_CHILD_STATE_VALUES: set[RecipeImageAvailabilityChildState] = { 'cancelled', 'failed', 'partial', 'queued', 'running', 'succeeded',  }
