...
RunSwitchMemberProgressPhaseType0 = Literal['cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify']

RUN_SWITCH_MEMBER_PROGRESS_PHASE_TYPE_0_VALUES: set[RunSwitchMemberProgressPhaseType0] = { 'cleanup', 'final_verify', 'prepare', 'start', 'stop', 'transfer', 'uninstall', 'verify',  }
