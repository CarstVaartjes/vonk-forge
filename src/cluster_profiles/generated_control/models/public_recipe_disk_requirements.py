...
T = TypeVar("T", bound="PublicRecipeDiskRequirements")



@_attrs_define
class PublicRecipeDiskRequirements:
    """
        Attributes:
            artifact_bytes (int):
            cache_bytes (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_recipe_disk_requirements = cls(
            artifact_bytes=artifact_bytes,
            cache_bytes=cache_bytes,
            image_bytes=image_bytes,
            rollback_bytes=rollback_bytes,
        ...
        return public_recipe_disk_requirements
