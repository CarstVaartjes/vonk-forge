...
FleetProfileAssignmentPreviewActionsItem = Literal['build', 'create-placement', 'distribute-image', 'install', 'keep', 'start', 'stop']

FLEET_PROFILE_ASSIGNMENT_PREVIEW_ACTIONS_ITEM_VALUES: set[FleetProfileAssignmentPreviewActionsItem] = { 'build', 'create-placement', 'distribute-image', 'install', 'keep', 'start', 'stop',  }
