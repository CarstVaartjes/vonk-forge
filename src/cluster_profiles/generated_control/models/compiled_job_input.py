...
if TYPE_CHECKING:
  from ..models.compiled_job_input_slot import CompiledJobInputSlot





T = TypeVar("T", bound="CompiledJobInput")



@_attrs_define
class CompiledJobInput:
    """ Typed compiled form of the public ``RecipeJobInput`` declaration.
        ...
        Attributes:
            ...
            path (Literal['/inputs']):
            required (bool):
            slots (Union[None, Unset, list['CompiledJobInputSlot']]):
     """
    ...
    path: Literal['/inputs']
    required: bool
    slots: Union[None, Unset, list['CompiledJobInputSlot']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_slots(data: object) -> Union[None, Unset, list['CompiledJobInputSlot']]:
            if data is None:
                return data
            ...
            try:
                ...
                for slots_type_0_item_data in (_slots_type_0):
                    slots_type_0_item = CompiledJobInputSlot.from_dict(slots_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['CompiledJobInputSlot']], data)

        slots = _parse_slots(d.pop("slots", UNSET))


        compiled_job_input = cls(
            max_bytes=max_bytes,
            media_types=media_types,
            path=path,
            required=required,
