...
from ...models.run_switch_cancel_request import RunSwitchCancelRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/recipes/run-switches/{operation_id}/cancel".format(operation_id=operation_id,),
    }
