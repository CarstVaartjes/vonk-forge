...
from ...models.fleet_profile_preview_request import FleetProfilePreviewRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/fleet-profiles/{profile_id}/preview".format(profile_id=profile_id,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        profile_id (str):
        body (FleetProfilePreviewRequest): Explicit empty body keeps CSRF-protected preview calls
            typed.
