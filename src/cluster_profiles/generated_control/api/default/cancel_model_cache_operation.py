...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/model-cache/operations/{operation_id}/cancel".format(operation_id=operation_id,),
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[BoundedErrorResponse, ModelCacheOperationResponse, RequestValidationProblem]]:
    if response.status_code == 200:
        response_200 = ModelCacheOperationResponse.from_dict(response.json())
