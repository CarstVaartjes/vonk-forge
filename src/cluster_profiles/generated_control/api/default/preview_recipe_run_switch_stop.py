...
from ...models.run_switch_stop_preview_request import RunSwitchStopPreviewRequest
...
def _get_kwargs(
    *,
    body: RunSwitchStopPreviewRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/recipes/run-switch-stops/preview",
    }
