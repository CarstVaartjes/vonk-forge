...
from ...models.recipe_image_availability_retry import RecipeImageAvailabilityRetry
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/library/recipe-image-availability/{operation_id}/retry".format(operation_id=operation_id,),
    }
