...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/fleet-profiles/{profile_id}/prepare/preview".format(profile_id=profile_id,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        profile_id (str):
        body (FleetProfilePreparePreviewRequest): Explicit empty body for the digest-bound
            preparation preview.
