...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/model/operations/{operation_id}/cancel".format(operation_id=operation_id,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        operation_id (str):
        body (ModelCacheCancellationRequest): Stable identity and operator explanation for one
